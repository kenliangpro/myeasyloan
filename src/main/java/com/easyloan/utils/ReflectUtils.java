...
import com.easyloan.bean.Admin;
...
//        map.put("id",UUIDUtils.toPrimaryKey());
//        map.put("adminName","liangjian");
//        map.put("registerTime",FormatDate.formatDate(new Date()));
//        setFieldValue(admin,map);
//        System.out.println(admin);
//        Map<String, String> valueMap = getFieldValueMap(admin);
//        System.out.println(valueMap);
        PersonalLoan personalLoan = new PersonalLoan();
        map.put("status",0 + "");
        setFieldValue(personalLoan,map);
